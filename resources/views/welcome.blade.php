...
@extends('layouts.header_imgSlader')
      ...
      <div class="container-fluid p-0">
        <div class="row no-gutters ">
          <div class="col-lg-4 col-sm-6">
            ...
            <!-- LIEN -->
            <a class="portfolio-box" href="/produits/1">
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <a class="portfolio-box" href="/produits/2">
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="/produits/3">
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="/produits/4">
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="/produits/5">
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="/produits/6">
